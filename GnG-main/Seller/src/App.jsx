...
function Layout({ children }) {
  return (
    <section className="main">
      <Header />
      <div className="mainContaint flex flex-col lg:flex-row">
        {/* Sidebar */}
        <div className="sidebarWrapper w-full lg:w-[18%]">
          <SideBar />
        </div>
        {/* Content */}
        <div className="contentRight w-full lg:w-[82%] py-4 px-3">
          {children}
        </div>
      </div>
    </section>
  ...
  return (
    <MyContext.Provider value={values}>
      ...
      >
        ...
        {/* Conditional rendering of models */}
