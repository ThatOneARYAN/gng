...
function AddProduct() {
  ...
  return (
    <section className="p-5 bg-gray-50">
      <form className="py-2 px-10">
        <span className="grid grid-cols-1 mb-3">
  ...
  <label htmlFor="description" className="text-[14px] font-medium mb-1 block">
    Product Description
  </label>
  <textarea
    id="description"
    ...
    onChange={handleChange}
    className="w-full p-3 text-sm h-[60px] border border-gray-300 rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
  />
</span>


        <span className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-3">
        ...
        <span className="grid grid-cols-3 gap-5 mb-3">
          <input
            type="text"
            name="brand"
            value={Product.brand}
        ...
        {/* Upload Images */}
        <span className="flex flex-wrap gap-4 mb-8 text-gray-500">
  ...
  <label htmlFor="multi-img" className="cursor-pointer">
    <span className="w-24 h-24 flex items-center justify-center border-2 border-dashed bg-gray-100 text-sm text-center">
      + Upload
    </span>
  </label>
  ...
  />
        ...
        <Button
  type="button"
  className="flex items-center justify-center gap-2 btn-blue btn-lg w-full sm:w-[50%] md:w-[40%] lg:w-[30%]"
  onClick={addproduct}
>
