...
function AddCategory() {
  ...
  return (
    ...
    <form className="h-auto py-2 px-4 sm:px-6 md:px-10 max-w-[600px] mx-auto">
      <div className="grid grid-cols-1 mb-3">
        ...
        <div className="uploadimg w-full p-2 px-1">
          ...
          <input type="file" accept="image/*" onChange={handleImageChange} className="w-full p-3 text-sm h-[40px] border border-[rgba(0,0,0,0.4)] bg-white" />
          {preview && <img src={preview} alt="Preview" width="100" height="100" className="mt-2" />}
        </div>

        <br />
        <Button className="flex items-center justify-center gap-2 btn-blue btn-lg w-full sm:w-[40%] md:w-[16%]" onClick={addCategory}>
