  ...
  return (
    <>
      <div className="products shadow-md rounded-md py-2 px-5 bg-white">
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-0 justify-between pt-3 items-start sm:items-center">
          <h4 className="text-[20px] text-left font-[600]">Home Slider Banners</h4>
          <Button
            className="btn-blue sm:ml-auto"
            onClick={() =>
