...
function Layout({ children }) {
  return (
    <section className='main'>
      <ToastContainer />
      <Header />
      <div className="mainContaint flex flex-col md:flex-row">
        <div className="sidebarWrapper w-full md:!w-[18%]">
          <SideBar />
        </div>
        <div className="contentRight w-full md:!w-[82%] !py-4 !px-3">
          {children}
        </div>
      </div>
    </section>
...
function App() {
  ...
  const router = createBrowserRouter([
    ...
    { path: '/orders', element: <Layout><OrdersList /></Layout> },
    { path: '/Homesliderbanners', element: <Layout><HomeSliderBaneerList /></Layout> },
    { path: '/categorylist', element: <Layout><CategoryList /></Layout> },
    { path: '/subcategorylist', element: <Layout><SubCategoryList /></Layout> },
    { path: '/users', element: <Layout><UsersList /></Layout> },
  ]);
