...
function SideBar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`sidebar fixed top-0 left-0 z-40 w-[75%] sm:w-[60%] md:w-[40%] lg:w-[18%] bg-white h-full border-r border-[rgba(0,0,0,0.1)] transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <ul className="pt-2 !font-[600]">
          ...
          <li>
            ...
            <ReactCollapse isOpened={submenuIndex === 1}>
              <ul className="w-full">
          ...
          <li>
            ...
            <ReactCollapse isOpened={submenuIndex === 3}>
              <ul className="w-full">
                <li className="!w-full">
                  <Link to="/products">
                    <Button
          ...
          <li>
            ...
            <ReactCollapse isOpened={submenuIndex === 4}>
              <ul className="w-full">
                <li className="!w-full">
          ...
          <li>
            <Button className="w-full !py-3 !font-[600] !justify-start !px-6 flex !gap-3 !text-[16px] !text-[rgba(0,0,0,0.8)] hover:!bg-[#f1f1f1]">
              ...
              <span style={{ textTransform: "initial" }} onClick={handleLogout}>
                Logout
              </span>
            </Button>
          </li>
