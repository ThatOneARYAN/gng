...
>
        <SwiperSlide>
            <div className="box bg-white !p-5 !cursor-pointer hover:bg-[#f1f1f1] rounded-md border flex items-center gap-4 border-[rgba(0,0,0,0.1)] mobile-square">
        ...
        <SwiperSlide>
            <div className="box !p-5 bg-white !cursor-pointer hover:bg-[#f1f1f1] rounded-md border flex items-center gap-4 border-[rgba(0,0,0,0.1)] mobile-square">
