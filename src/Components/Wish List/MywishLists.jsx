  ...
  return (
    <div>
       <div className="cartitems border-b border-gray-100 w-full sm:p-3 p-3 flex items-center sm:gap-4 gap-3">
        <div className="img lg:!w-[12%]  !w-[20%] rounded-md overflow-hidden">
        ...
        <div className="info w-[75%] sm:w-[85%]   relative">
          ...
          <h3 className="md:text-[16px] py-1 text-[11px]  text-black">
            <Link to="/productdetails/2" className="link">
              Red Velvet Fresh Cream Cake Half kg
            </Link>
          </h3>

          <div className="flex items-center !py-1 gap-1 sm:gap-3">
          ...
          <div className="flex items-center !py-1  gap-4 ">
            ...
            <span className="price text-[#7d0492] sm:text-[12px] text-[10px] font-[600]">
              20% off
            </span>
          </div>
        </div>
